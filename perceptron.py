...
class Tree_Perceptron:
    ...
    def update_parameters(self, X, y, Prob_List):
        print('instance arrived')
    ...
    def run_ai(self, ai, class_i, yp):
        ...
        theta, cost = self.logistic_regression(np.array([ai]), yp, self.learning_rate, 3, theta)

        # for j in range(self.n_tree+1):
        #     self.parameters[class_i][j] = theta[j]
